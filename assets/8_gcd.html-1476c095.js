import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as s,c as o,a as t,b as l,d as i,f as u}from"./app-833b555e.js";const a={},c={href:"https://codeforces.com/contest/1766/problem/D",target:"_blank",rel:"noopener noreferrer"},v=t("li",null,"题意找到连续的最长gcd(a+k，b+k) == 1(a < b,k = {0,1,2,...})",-1),r=t("li",null,"思路：",-1),b=t("li",null,"gcd(a+k,b+k) == gcd(a+k,b - a)",-1),m=t("li",null,"a - b = 1时特判",-1),q={href:"https://codeforces.com/blog/entry/110066",target:"_blank",rel:"noopener noreferrer"},f=t("li",null,"设两个的结果分别为g和h，显然a+k和b+k都是g的倍数，那么让其中一个大的倍数减掉一个小的倍数，显然还是g的倍数，充分性成立",-1),g=t("li",null,"反证法也同理，a+k和b-a肯定都是h的倍数，一个倍数加上另一个倍数，肯定还是h的倍数，必要性成立",-1),p=u(`<ul><li>接下来只需要找到b-a的质因子判断a+k是否有重复因子</li><li>一个一个加显然超时，我们可以先预处理出每个数字的最大质因子，然后利用传递性，得到关于b-a的所有质因子</li><li>设当前质因子为temp，更新答案的方法就是ans = min(ans,(temp - a%temp) % temp)</li></ul><p>代码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include&lt;bits/stdc++.h&gt;
