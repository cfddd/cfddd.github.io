import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as t,c as d,a as i,b as s,d as a,f as u}from"./app-f94c3d64.js";const v={},c={href:"https://atcoder.jp/contests/abc259/tasks/abc259_f",target:"_blank",rel:"noopener noreferrer"},r=i("li",null,"树形dp（最简单的那种类型，但是题目的方法还是很巧妙的）",-1),o=i("li",null,"易知：负权边可以忽略",-1),b=u(`<h2 id="思路" tabindex="-1"><a class="header-anchor" href="#思路" aria-hidden="true">#</a> 思路</h2><h3 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h3><ul><li>定义f[i][0]表示以i为根的子树尽量用到d[i]-1条边的最大可能（留一条边给父节点联通用）</li><li>f[i][1]表示以i为根的子树尽量用到d[i]条边的最大可能</li></ul><h3 id="转移" tabindex="-1"><a class="header-anchor" href="#转移" aria-hidden="true">#</a> 转移</h3><ul><li>就是那个最简单的树形dp，不能相邻放的</li><li>f[i][0] = f[j][1],f[j][0] + w[idx]（j为前d[i]-1条最大的子路）</li><li>f[i][1] = f[i][0] + (接着最大的一条边)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include&lt;bits/stdc++.h&gt;
