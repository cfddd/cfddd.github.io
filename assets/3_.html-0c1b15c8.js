import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as e,c as d,a as i,b as s,d as v,f as u}from"./app-8cc557db.js";const a={},r={href:"https://atcoder.jp/contests/arc120/tasks/arc120_c",target:"_blank",rel:"noopener noreferrer"},c=u(`<p>势能就是i + a[i],很有用的结论<br> 对于能完成交换，从A变成B，势能数组一定相同<br> 找出最小交换次数，贪心的方案是：最近的先交换<br> 找到最近的在可以用数组数组和set实现<br> 具体细节见代码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include&lt;bits/stdc++.h&gt;
